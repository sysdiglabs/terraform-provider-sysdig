		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("data.sysdig_monitor_notification_channel_slack.nc_slack", "show_section_notification_chart", "sysdig_monitor_notification_channel_slack.show_section_dashboard_links", "show_section_dashboard_links"),
					resource.TestCheckResourceAttrPair("data.sysdig_monitor_notification_channel_slack.nc_slack", "show_section_notification_chart", "sysdig_monitor_notification_channel_slack.show_section_alert_details", "show_section_alert_details"),
					resource.TestCheckResourceAttrPair("data.sysdig_monitor_notification_channel_slack.nc_slack", "show_section_notification_chart", "sysdig_monitor_notification_channel_slack.show_section_capturing_information", "show_section_capturing_information"),
				),
			},
		},
	})
