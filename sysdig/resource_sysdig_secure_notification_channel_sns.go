...
func resourceSysdigSecureNotificationChannelSNS() *schema.Resource {
	...
	return &schema.Resource{
		Create: resourceSysdigNotificationChannelSNSCreate,
		Update: resourceSysdigNotificationChannelSNSUpdate,
		Read:   resourceSysdigNotificationChannelSNSRead,
		Delete: resourceSysdigNotificationChannelSNSDelete,
...
func resourceSysdigNotificationChannelSNSCreate(d *schema.ResourceData, meta interface{}) error {
...
func resourceSysdigNotificationChannelSNSRead(d *schema.ResourceData, meta interface{}) error {
	client, err := meta.(SysdigClients).sysdigSecureClient()
	if err != nil {
		return err
	}
...
func resourceSysdigNotificationChannelSNSUpdate(d *schema.ResourceData, meta interface{}) error {
	client, err := meta.(SysdigClients).sysdigSecureClient()
	if err != nil {
		return err
	}
...
func resourceSysdigNotificationChannelSNSDelete(d *schema.ResourceData, meta interface{}) error {
	client, err := meta.(SysdigClients).sysdigSecureClient()
	if err != nil {
		return err
	}
