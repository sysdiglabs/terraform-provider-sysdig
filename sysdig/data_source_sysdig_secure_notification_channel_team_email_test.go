		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttrPair("data.sysdig_secure_notification_channel_team_email.nc_team_email_2", "team_id", "sysdig_secure_notification_channel_team_email_2.nc_team_email_2", "team_id"),
					resource.TestCheckResourceAttrPair("data.sysdig_secure_notification_channel_team_email.nc_team_email_2", "include_admin_users", "sysdig_secure_notification_channel_team_email_2.nc_team_email_2", "include_admin_users"),
				),
			},
		},
	})
