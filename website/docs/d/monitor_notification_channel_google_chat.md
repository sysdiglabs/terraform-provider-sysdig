...
description: |-
  Retrieves information about a Monitor notification channel of type Google Chat
---

# Data Source: sysdig_monitor_notification_channel_google_chat
...
* `url` - URL of the Google Chat webhook.
