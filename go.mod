...
require (
	...
	github.com/sysdiglabs/agent-kilt/runtimes/cloudformation v0.0.0-20240918132158-1e6e885909c5
...
require (
	...
	github.com/sysdiglabs/agent-kilt/pkg v0.0.0-20240808103223-011d2ea63e8a // indirect
